...
function fileLoader(name, context, cb) {
...
exports.create = function (config) {
    ...
    var dust = freshy('dustjs-linkedin', function (dust) {
        ...
        if (config.helpers && config.helpers.forEach) {
        ...
        // Let's get ourselves some dust.addLoadMiddleware
        dustjacket.registerWith(dust);

        if (config.loaders && config.loaders.forEach) {
            config.loaders.forEach(dust.addLoadMiddleware);
        }

        dust.addLoadMiddleware(fileLoader);
